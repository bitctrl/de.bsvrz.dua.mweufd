...
SET jar=de.bsvrz.dua.mweufd-runtime.jar
...
CHCP 1252
TITLE Messwertersetzung UFD
java %jvmArgs% ^
de.bsvrz.dua.mweufd.vew.VerwaltungMesswertErsetzungUFD ^
-debugLevelStdErrText=info ^
-debugSetLoggerAndLevel=:config ^
-datenverteiler=%dav1Host%:%dav1AppPort% ^
-benutzer=%benutzer% ^
-authentifizierung=%passwortDatei% ^
-KonfigurationsBereichsPid=kb.aoe.bitctrl.tester,kb.duaTestModellUndObjekte
