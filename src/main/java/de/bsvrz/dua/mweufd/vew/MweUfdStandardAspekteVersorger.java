...
public class MweUfdStandardAspekteVersorger extends StandardAspekteVersorger {
	 ...
	 *             wird weitergereicht
	 */
	public MweUfdStandardAspekteVersorger(final IVerwaltung verwaltung) throws DUAInitialisierungsException {
		super(verwaltung);
	}
	...
	protected void init() throws DUAInitialisierungsException {
		...
		setStandardAspekte( new StandardAspekteAdapter(new StandardPublikationsZuordnung[] {
				...
				new StandardPublikationsZuordnung("typ.ufdsFahrBahnGlätte", //$NON-NLS-1$
						"atg.ufdsFahrBahnGlätte", //$NON-NLS-1$
						DUAKonstanten.ASP_PL_PRUEFUNG_LOGISCH, DUAKonstanten.ASP_MESSWERTERSETZUNG),
				new StandardPublikationsZuordnung("typ.ufdsFahrBahnOberFlächenTemperatur", //$NON-NLS-1$
						"atg.ufdsFahrBahnOberFlächenTemperatur", //$NON-NLS-1$
						DUAKonstanten.ASP_PL_PRUEFUNG_LOGISCH, DUAKonstanten.ASP_MESSWERTERSETZUNG),
				new StandardPublikationsZuordnung("typ.ufdsFahrBahnOberFlächenZustand", //$NON-NLS-1$
				...
				new StandardPublikationsZuordnung("typ.ufdsLuftDruck", //$NON-NLS-1$
						...
						DUAKonstanten.ASP_PL_PRUEFUNG_LOGISCH, DUAKonstanten.ASP_MESSWERTERSETZUNG),
				new StandardPublikationsZuordnung("typ.ufdsLuftTemperatur", //$NON-NLS-1$
				...
				new StandardPublikationsZuordnung("typ.ufdsNiederschlagsArt", //$NON-NLS-1$
						...
						DUAKonstanten.ASP_PL_PRUEFUNG_LOGISCH, DUAKonstanten.ASP_MESSWERTERSETZUNG),
				new StandardPublikationsZuordnung("typ.ufdsNiederschlagsIntensität", //$NON-NLS-1$
				...
				new StandardPublikationsZuordnung("typ.ufdsNiederschlagsMenge", //$NON-NLS-1$
						...
						DUAKonstanten.ASP_PL_PRUEFUNG_LOGISCH, DUAKonstanten.ASP_MESSWERTERSETZUNG),
				new StandardPublikationsZuordnung("typ.ufdsRelativeLuftFeuchte", //$NON-NLS-1$
				...
				new StandardPublikationsZuordnung("typ.ufdsSichtWeite", //$NON-NLS-1$
						...
						DUAKonstanten.ASP_PL_PRUEFUNG_LOGISCH, DUAKonstanten.ASP_MESSWERTERSETZUNG),
				new StandardPublikationsZuordnung("typ.ufdsTaupunktTemperatur", //$NON-NLS-1$
						"atg.ufdsTaupunktTemperatur", //$NON-NLS-1$
						DUAKonstanten.ASP_PL_PRUEFUNG_LOGISCH, DUAKonstanten.ASP_MESSWERTERSETZUNG),
				new StandardPublikationsZuordnung("typ.ufdsTemperaturInTiefe1", //$NON-NLS-1$
						"atg.ufdsTemperaturInTiefe1", //$NON-NLS-1$
						DUAKonstanten.ASP_PL_PRUEFUNG_LOGISCH, DUAKonstanten.ASP_MESSWERTERSETZUNG),
				new StandardPublikationsZuordnung("typ.ufdsTemperaturInTiefe2", //$NON-NLS-1$
						"atg.ufdsTemperaturInTiefe2", //$NON-NLS-1$
						DUAKonstanten.ASP_PL_PRUEFUNG_LOGISCH, DUAKonstanten.ASP_MESSWERTERSETZUNG),
				new StandardPublikationsZuordnung("typ.ufdsTemperaturInTiefe3", //$NON-NLS-1$
						"atg.ufdsTemperaturInTiefe3", //$NON-NLS-1$
						DUAKonstanten.ASP_PL_PRUEFUNG_LOGISCH, DUAKonstanten.ASP_MESSWERTERSETZUNG),
				new StandardPublikationsZuordnung("typ.ufdsWasserFilmDicke", //$NON-NLS-1$
						"atg.ufdsWasserFilmDicke", //$NON-NLS-1$
						DUAKonstanten.ASP_PL_PRUEFUNG_LOGISCH, DUAKonstanten.ASP_MESSWERTERSETZUNG),
				new StandardPublikationsZuordnung("typ.ufdsWindRichtung", //$NON-NLS-1$
						"atg.ufdsWindRichtung", //$NON-NLS-1$
						DUAKonstanten.ASP_PL_PRUEFUNG_LOGISCH, DUAKonstanten.ASP_MESSWERTERSETZUNG),
				new StandardPublikationsZuordnung("typ.ufdsWindGeschwindigkeitMittelWert", //$NON-NLS-1$
