...
/**
 * Implementierung der Messwertersetzung für FBZ-Sensoren
 * @author Kappich Systemberatung
 */
public class MweFbzSensor extends AbstractMweSensor {
	/**
	 * Standardkonstruktor.
	 *
	 ...
	 */
	public MweFbzSensor(final IVerwaltung verwaltung, final DUAUmfeldDatenMessStelle messStelle, final DUAUmfeldDatenSensor sensor) throws DUAInitialisierungsException, UmfeldDatenSensorUnbekannteDatenartException {
