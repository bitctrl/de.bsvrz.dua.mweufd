...
/**
 * Implementierung der Messwertersetzung für LT-Sensoren
 * @author Kappich Systemberatung
 */
public class MweLtSensor extends AbstractMweSensor {
	/**
	 * Standardkonstruktor.
	 *
	 ...
	 */
	public MweLtSensor(final IVerwaltung verwaltung, final DUAUmfeldDatenMessStelle messStelle, final DUAUmfeldDatenSensor sensor) throws DUAInitialisierungsException, UmfeldDatenSensorUnbekannteDatenartException {
	...
	protected void messwertErsetzung() {
		...
		switch(ersetzeVorgaengerNachfolger()) {
			case JA:
			case WARTE:
				return;
		}
