...
/**
 * Implementierung der Messwertersetzung für SW-Sensoren
 * @author Kappich Systemberatung
 */
public class MweSwSensor extends AbstractMweSensor {
	/**
	 * Standardkonstruktor.
	 *
	 ...
	 */
	public MweSwSensor(final IVerwaltung verwaltung, final DUAUmfeldDatenMessStelle messStelle, final DUAUmfeldDatenSensor sensor) throws DUAInitialisierungsException, UmfeldDatenSensorUnbekannteDatenartException {
