...
/**
 * Implementierung der Messwertersetzung für FBT-Sensoren
 * @author Kappich Systemberatung
 */
public class MweFbtSensor extends AbstractMweSensor {
	/**
	 * Standardkonstruktor.
	 *
	 ...
	 */
	public MweFbtSensor(final IVerwaltung verwaltung, final DUAUmfeldDatenMessStelle messStelle, final DUAUmfeldDatenSensor sensor) throws DUAInitialisierungsException, UmfeldDatenSensorUnbekannteDatenartException {
