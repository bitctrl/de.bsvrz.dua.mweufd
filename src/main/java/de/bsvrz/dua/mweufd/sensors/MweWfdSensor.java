...
/**
 * Implementierung der Messwertersetzung für WFD-Sensoren
 * @author Kappich Systemberatung
 */
public class MweWfdSensor extends AbstractMweSensor {
	/**
	 * Standardkonstruktor.
	 *
	 ...
	 */
	public MweWfdSensor(final IVerwaltung verwaltung, final DUAUmfeldDatenMessStelle messStelle, final DUAUmfeldDatenSensor sensor) throws UmfeldDatenSensorUnbekannteDatenartException {
